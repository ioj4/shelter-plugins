...
const bannerSelector = `div[class*="inner"] div[class*="banner"]`;
...
const subSelectors = [
    ...
    // pfp in old profile modal and pfp in popout of webhooks
    `div[class*="nner"] div[class*="avatar"]:not([class*="clickable"]) > div[class*="wrapper"]`,
